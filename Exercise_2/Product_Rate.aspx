...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="ContentDetails">
    <span style="font-family: Arial, Helvetica, sans-serif; font-size: x-large; margin-left: 25em; margin-right: 7em;">Product Rate List</span>
    ...
    <div>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="ProductName" SortExpression="ProductName">
                    <EditItemTemplate>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:PartyProductConnectionString %>" SelectCommand="SELECT [ProductName] FROM [Products]"></asp:SqlDataSource>
                    </EditItemTemplate>
                    <ItemTemplate>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PartyProductConnectionString%>" SelectCommand="select prr.id,pr.ProductName,prr.Rate,Prr.Date_Of_Rate from ProductRate prr inner join Products pr on prr.Product_id=pr.id"
